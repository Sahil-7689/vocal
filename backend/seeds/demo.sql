...
('c0000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 'owner'),
('c0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000001', '22222222-2222-2222-2222-222222222222', 'editor'),
('c0000000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000001', '33333333-3333-3333-3333-333333333333', 'viewer'),
('c0000000-0000-0000-0000-000000000004', 'b0000000-0000-0000-0000-000000000002', '44444444-4444-4444-4444-444444444444', 'owner');

-- Insert Org A Demo Workflow
INSERT INTO public.workflows (id, org_id, name, description, status, created_by) VALUES
('f0000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'Customer Support Agent Workflow', 'Processes customer tickets via LLM, REST API calls, conditional checks, owner review gate, and DB audit logging.', 'active', '11111111-1111-1111-1111-111111111111');
...
('d0000000-0000-0000-0000-000000000001', 'f0000000-0000-0000-0000-000000000001', 'manual', '{}'::jsonb, true),
('d0000000-0000-0000-0000-000000000002', 'f0000000-0000-0000-0000-000000000001', 'webhook', '{"secret": "vf_sec_99881122"}'::jsonb, true);
